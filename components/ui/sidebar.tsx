...
>(
  (
    ...
    const isMobile = useIsMobile({ breakpoint: MOBILE_BREAKPOINT });
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-side=left][data-state=collapsed]_&]:hidden [[data-side=right][data-state=collapsed]_&]:hidden",
...
const sidebarMenuButtonVariants = cva(
  "group/menu-button flex w-full items-center gap-2 truncate rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-semibold data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      tabIndex={0}
      className={cn(
        "flex h-5 w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-[transform,width] hover:bg-sidebar-foreground/10 hover:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        // "after:absolute after:-inset-2 after:md:hidden",
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover && "overflow-hidden group-hover/menu-button:w-5 md:w-0",
        className,
      )}
      {...props}
    />
